  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          I’m enthusiastic about crafting real-world solutions using frontend and backend technologies.
        </p>
        <p>
          I have a strong interest in <span className="text-yellow-600 font-semibold">Java</span> and <span className="text-purple-600 font-semibold">Object-Oriented Programming</span>.
        </p>
        <p>
          Apart from coding, I enjoy <span className="text-green-600 font-semibold">going on long drives</span> and <span className="text-pink-500 font-semibold">watching movies</span>.
        </p>
      </div>
